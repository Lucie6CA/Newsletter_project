...
class ArticleCountryFragment (subject: String): Fragment(), ListArticlesHandler {
    ...
    private fun bindData(articles: ArticleResponse) {
        lifecycleScope.launch(Dispatchers.Main) {
            ...
            val adapter = ListArticlesAdapter(articles,this@ArticleCountryFragment, requireContext())
